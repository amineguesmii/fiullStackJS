...
const Value = tw.div`font-bold text-teal-500`
    ...
    <Container>
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <Heading>On a le meilleur service</Heading>
            <Description>Ras El-Jebel est l'une des délégations de la République tunisienne, appartenant à la gouvernera de Bizerte. Notre commune tente à offrir les meilleurs services à nos citoyens pour une vie plus confortable.</Description>
            <Statistics>
